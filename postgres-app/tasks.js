...
// This CREATE_TABLE_SQL is somewhat self explanatory.
const CREATE_TABLE_SQL = `CREATE TABLE IF NOT EXISTS tasks
(id SERIAL, task TEXT NOT NULL, PRIMARY KEY ( id ));`;

const INSERT_TASK_SQL = `INSERT INTO tasks (task) VALUES ($1);`; // Note the use of $1 here to indicate the input of parameters, in this case $1 correlates to task, 
...
const GET_TASKS_SQL = `SELECT * FROM tasks;`; // display the table tasks
