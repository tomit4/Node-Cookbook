...
declare const LoopbackBookstoreApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class LoopbackBookstoreApplication extends LoopbackBookstoreApplication_base {
